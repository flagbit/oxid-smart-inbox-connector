...
class MappingTest extends TestCase
{
    ...
    public function provideStatus(): array
    {
        return [
            ...
            'Payment due and in delivery (null)' => ['OK', 'OrderPaymentDue', '2020-10-10', null, 0, 'ORDERFOLDER_NEW'],
            'Payment due and in delivery' => ['OK', 'OrderPaymentDue', '2020-10-10', '0000-00-00 00:00:00', 0, 'ORDERFOLDER_NEW'],
            'Paid but not in delivery (null)' => ['OK', 'OrderProcessing', null, '2020-10-10', 0, 'ORDERFOLDER_NEW'],
            'Paid but not in delivery' => ['OK', 'OrderProcessing', '0000-00-00 00:00:00', '2020-10-10', 0, 'ORDERFOLDER_NEW'],
