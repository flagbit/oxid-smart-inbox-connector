...
class MappingTest extends TestCase
{
    ...
    public function provideStatus(): array
    {
        return [
            ...
            'Payment due and in delivery (null)' => ['OK', 'OrderInTransit', '2020-10-10', null, 0, 'ORDERFOLDER_NEW'],
            'Payment due and in delivery' => ['OK', 'OrderInTransit', '2020-10-10', '0000-00-00 00:00:00', 0, 'ORDERFOLDER_NEW'],
